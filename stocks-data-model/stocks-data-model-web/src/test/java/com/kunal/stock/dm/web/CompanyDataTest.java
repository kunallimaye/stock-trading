...
public class CompanyDataTest {
    ...
    public static Archive<?> createTestArchive() {
        return TestWebDeploymentArchive.createTestArchive("company-data-test.war");
    }
	@Test
    ...
    @RunAsClient
    @Test
    public void testInvokeCompaniesRS() throws Exception{
    	ClientRequest request = new ClientRequest(
				"http://localhost:8080/company-data-test/rest/" + Constants.COMPANY_REST_SERVICE
